...
if __name__ == '__main__':
    ...
    recipe5 = Recipes.create(
       title = 'Каша из Булгура с тыквой и яблоками',
        subtitle = '2|1',
        description  = 'Каша из Булгура является невероятно сытным и аппетитным блюдом и даст отличный старт на долгий день. Это блюдо зарядит энергией и подарит чувство насыщения на несколько часов, ведь крупа под названием “Булгур” очень богата железом, калием, витаминами, фолиевой кислотой и клетчаткой. Она оказывает благотворное влияние на работу сердечно-сосудистой системы, способствует сжиганию жиров и снижению сахара в крови. Содержащиеся в составе крупы сложные углеводы усваиваются медленно, не нанося ущерб фигуре.',
        price = 100,
        tag = "гарнир",
    ...
    recipe6 = Recipes.create(
        ...
        subtitle = '2|1',
        description  = 'Приготовление “parmigiana,” а именно так с итальянского переводится курица с Пармезаном, очень легкое и и простое. Это блюдо состоит из тонко нарезанного куриного филе, покрытым  оливковым маслом, затем покрытым томатным соусом и слегка запеченного. В нашем рецепте мы остаемся верными традициями, поэтому накрываем на стол курицу вместе с пастой. Паста из цельных сортов пшеницы очень вкусно сочетается со шпинатом и цуккини с невероятным вкусом пикантного пармезана.',
        price = 100,
        tag = "мясо",
        photo = 'https://rocket04.imgix.net/kyriza-s-parmezanom.png?s=c913f69ab13abce4df5036ed5313cfea',
        ingredients = 'Филе курицы|Спагетти|Томатная паста|Сыр Моцарелла|Чеснок|Шпинат|Лук|Цуккини|Мука|Сыр Пармезан|Петрушка|Оливковое масло|Соль',
    ...
    recipe10 = Recipes.create(
        ...
        ingredients = 'Киноа|Корица молотая|Смородина черная|Сахар тростниковый|Молоко 3,2% 200гр|Масло топленое|Мед цветочный|Груша',
    ...
    recipe11 = Recipes.create(
        title = 'Куриная Лапша',
        subtitle = '2|1',
        description  = 'Куриная лапша – один из самых популярных домашних супов. Он всегда получается очень нежным и вкусным. Это очень легкий суп, который ко всему прочему очень быстро и просто готовится. При этом куриная лапша - это очень питательный обед, идеальный в любых случаях будь вы на работе, или дома.',
        price = 100,
        tag = "основное блюдо",
    ...
    recipe12 = Recipes.create(
        ...
        subtitle = '2|1',
        description  = 'Французский маффин является гордостью французской кухни, но даже за пределами Франции, практически, в каждом уважающем себя ресторане вы сможете отведать уникальную интерпретацию этого рецепта. В нашем рецепте мы попытались сохранить основы здорового питания и как бы смешно это не звучало, это так и есть. Данный рецепт подходит одинаково хорошо как для тех, кто любит что-то сладкое к чаю, так и для тех, кто старается максимально строго придерживаться правильного питания.',
        price = 100,
        tag = "дессерт",
    ...
    recipe18 = Recipes.create(
        ...
        subtitle = '2|1',
        description  = 'Для этого невероятно вкусного ризотто, мы будем использовать брынзу для идеального сочетания, с одним из наших любимых овощей - буряков. Помните, кулинарные шефы, комбинация из брынзы и буряка это не просто эстетическое удовольствие, но это и идеальное сочетание сладкого и терпкого вкусов. Во время приготовления буряк отдает свой цвет и вкус ячменю что в сочетании с салатом и луком делает данное блюдо незабываемым.',
        price = 100,
        tag = "гарнир",
    ...
    recipe20 = Recipes.create(
        ...
        subtitle = '2|1',
        description  = 'Как влияет цвет еды на наши вкусовые рецепторы, всем известно! Тальятелле с креветками - это как раз яркий пример блюда, которое можно съесть уже глазами! Нежные цвета креветок, светлого цукини, алых томатов, зеленой петрушки, белого сливочного соуса и яичной лапши таглиателле дополняет изумительный аромат.',
        price = 100,
        tag = "основное блюдо",
        photo = 'https://rocket04.imgix.net/taliatelle-s-krevetkami.png?s=e82276004f177564c238a049b3b16760',
        ingredients = 'Сливки|Креветки тигровые|Тальятелле яичные|Помидоры Черри|Петрушка|Тимьян|Сыр Пармезан|Лук|Чеснок|Цукини',
